...
```bash
go get github.com/input-output-hk/catalyst-forge-ai/lib/oci
```
...
import (
    ...
    "github.com/input-output-hk/catalyst-forge-ai/lib/oci"
)
...
- [`Client`](https://pkg.go.dev/github.com/input-output-hk/catalyst-forge-ai/lib/oci#Client) - Main client for operations
- [`ClientOptions`](https://pkg.go.dev/github.com/input-output-hk/catalyst-forge-ai/lib/oci#ClientOptions) - Configuration options
- [`BundleError`](https://pkg.go.dev/github.com/input-output-hk/catalyst-forge-ai/lib/oci#BundleError) - Detailed error information
- [`Archiver`](https://pkg.go.dev/github.com/input-output-hk/catalyst-forge-ai/lib/oci#Archiver) - Archive format interface
- [`Validator`](https://pkg.go.dev/github.com/input-output-hk/catalyst-forge-ai/lib/oci#Validator) - Security validation interface
